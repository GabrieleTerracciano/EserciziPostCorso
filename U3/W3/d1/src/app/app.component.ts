...
export class AppComponent {
  ...
  @ViewChild('form', { static: true }) form!: NgForm; //Attraverso il decoratore ViewChild il componente intercetta i cambiamenti nell'oggetto indicato (form) e può gestirli; static true in quanto il component deve leggere i valori come statici.
  ...
  submit() {
    ...
    //I valori dell'oggetto user sono definiti soltanto in funzione della stampa
