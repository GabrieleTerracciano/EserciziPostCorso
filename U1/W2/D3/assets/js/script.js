...
//Lo switch case verifica il valore di mese 12 volte, invece con lo switch solo 1,QUINDI MOLTO PIU LENTO
//Il break non è obbligatorio ma consigliato, fa uscire dallo switch quando la condizione si verifica
//default  non è obbligatorio ma consigliato, si mette alla fine e indica un caso valido nel caso non si verifichi nessun altro caso
switch (mese) {
	case 0:
...
//Con il metodo if è molto meno leggibile
// if (x > y) {
// 	if (z > x) {
